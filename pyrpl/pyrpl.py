...
class Pyrpl(object):
    ...
    **kwargs: dict
    ...
    def __init__(self,
        ...
        if config is None:
            # Removed gui support, command line only
    ...
    def show_gui(self):
        self.logger.warning("No gui support, command show_gui ignored")
        pass # Removed gui support

    def hide_gui(self):
        self.logger.warning("No gui support, command hide_gui ignored")
        pass # Removed gui support
